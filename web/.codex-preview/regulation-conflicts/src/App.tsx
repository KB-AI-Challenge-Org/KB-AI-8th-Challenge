...
type GovernanceView = 'dashboard' | 'review' | 'knowledge-base' | 'conflicts'
...
function GovernanceOverview({ onReview }: { onReview: () => void }) {
  return (
    <motion.section
