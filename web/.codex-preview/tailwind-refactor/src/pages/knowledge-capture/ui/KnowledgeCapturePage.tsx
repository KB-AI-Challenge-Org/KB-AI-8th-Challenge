        ...
        >
          <header className="flex h-16 shrink-0 items-center justify-between px-7">
            <div className={`${topbarGroupClass} text-[15px]`}>
              ...
              <span className="text-[13px] text-tertiary">v6.2.14</span>
            </div>
          ...
          <nav className="flex h-[62px] shrink-0 items-center justify-between border-b border-border-subtle bg-surface px-7" aria-label="속마음 메뉴">
            <div className="flex self-stretch">
              <button className="min-w-24 cursor-pointer border-0 bg-transparent px-6 text-base font-bold text-secondary" type="button">속마음</button>
              <button className="relative min-w-24 cursor-pointer border-0 bg-transparent px-6 text-base font-bold text-primary after:absolute after:inset-x-6 after:bottom-0 after:h-[3px] after:bg-kb-yellow after:content-['']" type="button">기록하기</button>
              <button className="min-w-24 cursor-pointer border-0 bg-transparent px-6 text-base font-bold text-secondary" type="button">업무 이력</button>
            </div>
            <strong className="rounded-full bg-primary px-3.5 py-1.5 text-[13px] text-white">기업고객 밀집형</strong>
          </nav>
          ...
          >
            <aside className="flex w-[300px] shrink-0 flex-col gap-4">
              <motion.button
                type="button"
                className="w-full cursor-pointer rounded-xl border-0 bg-kb-yellow p-4 text-[15px] font-bold"
              ...
              <dl className="m-0 overflow-hidden rounded-[10px] border border-border-subtle bg-surface">
                {[
                  ...
                  <div className={`flex items-center justify-between px-[18px] py-3.5 text-[15px] ${index < 3 ? 'border-b border-border-subtle' : ''}`} key={label}>
